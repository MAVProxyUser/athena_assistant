...
{
class AudioAssistant : public athena_utils::LifecycleNode
{
public:
  AudioAssistant();
  ~AudioAssistant();
...
protected:
  /* Lifecycle stages */
  athena_utils::CallbackReturn on_configure(const rclcpp_lifecycle::State &) override;
  athena_utils::CallbackReturn on_activate(const rclcpp_lifecycle::State &) override;
  athena_utils::CallbackReturn on_deactivate(const rclcpp_lifecycle::State &) override;
  athena_utils::CallbackReturn on_cleanup(const rclcpp_lifecycle::State &) override;
  athena_utils::CallbackReturn on_shutdown(const rclcpp_lifecycle::State &) override;
