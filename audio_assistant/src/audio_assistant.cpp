...
: athena_utils::LifecycleNode("audio_assistant")
{
...
athena_utils::CallbackReturn AudioAssistant::on_configure(const rclcpp_lifecycle::State &)
{
...
athena_utils::CallbackReturn AudioAssistant::on_activate(const rclcpp_lifecycle::State &)
{
...
athena_utils::CallbackReturn AudioAssistant::on_deactivate(const rclcpp_lifecycle::State &)
{
...
athena_utils::CallbackReturn AudioAssistant::on_cleanup(const rclcpp_lifecycle::State &)
{
...
athena_utils::CallbackReturn AudioAssistant::on_shutdown(const rclcpp_lifecycle::State &)
{
...
// RCLCPP_COMPONENTS_REGISTER_NODE(athena_AudioAssistant::AudioAssistantActionClient)
